...
def Top2GatingOnLogits(inputs,
  ...
  # Chadwick: logits was generated by Einsum in ComputeGating
  # Chadwick: softmax in the paper
  tf.logging.info('############################################################')
  tf.logging.info('############################################################')
  tf.logging.info('Softmax on logits')
  ...
  tf.logging.info('############################################################')
  tf.logging.info('############################################################')
  tf.logging.info('Expert 1 index')
  ...
  # GSE
  # Confirmed: experts_dim is the number of experts e_dim
  tf.logging.info('############################################################')
  tf.logging.info('############################################################')
  tf.logging.info('One hot mask, expert 1')
  ...
  # Chadwick: Inspect sampling later
  if second_expert_policy == 'sampling':
    ...
    tf.logging.info('############################################################')
    tf.logging.info('############################################################')
    tf.logging.info('Expert 2 index')
  ...
  if second_expert_policy == 'all' or second_expert_policy == 'sampling':
    pass
  # Chadwick: May want to try this random policy
...
def ComputeGating(w,
  ...
  # Confirmed: We are using 'gating_einsum'
